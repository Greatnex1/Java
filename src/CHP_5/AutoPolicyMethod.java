...
public class AutoPolicyMethod {
    ...
    // constructor
    public AutoPolicyMethod (int accountNumber, String makeAndModel,
                      String state) {
    ...
    public String getState() {
        return state;
    }// using a boolean /predicate method returns whether the state has no-fault insurance
